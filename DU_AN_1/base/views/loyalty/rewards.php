    ...
    <main class="container mx-auto px-4 py-10">
        <div class="max-w-6xl mx-auto">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl md:text-4xl font-extrabold text-slate-900 mb-2">Đổi Mã giảm giá</h1>
            ...
            <div class="bg-white rounded-3xl border border-[#f0d8c8] p-10 text-center shadow-sm">
                <span class="material-icons text-6xl text-gray-400 mb-4">confirmation_number</span>
                <p class="text-slate-600 text-lg mb-4">Hiện chưa có mã giảm giá nào để đổi</p>
                <a href="<?= BASE_URL ?>?action=loyalty" class="inline-flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-lg hover:opacity-90 font-semibold">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                ?>
                <div class="bg-white rounded-3xl p-6 shadow-sm border <?= $hasRedeemed ? 'border-gray-200 opacity-60' : 'border-[#f0d8c8] hover:border-[#f3cdb7]' ?> transition-all">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <?php else: ?>
                                <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center">
                                    <span class="material-icons text-3xl text-green-600">sell</span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="border-t pt-4">
                        ...
                        <?php else: ?>
                            <form method="POST" action="<?= BASE_URL ?>?action=loyalty-redeem" onsubmit="return confirm('Bạn có chắc muốn đổi mã này?');">
                                ...
                                <button type="submit" class="w-full py-3 bg-primary text-white rounded-lg font-semibold hover:opacity-90 transition-colors">
                                    Đổi ngay
                                </button>
                            </form>
                        <?php endif; ?>
