    ...
    <main class="flex-1">
        <div class="px-4 sm:px-10 lg:px-20 flex justify-center py-10">
            <div class="flex flex-col w-full max-w-7xl">
                <h1 class="text-slate-900 text-3xl md:text-4xl font-extrabold leading-tight mb-6">Giỏ hàng của bạn</h1>
                ...
                <?php if (empty($cartData)): ?>
                    <div class="bg-white dark:bg-slate-800/50 rounded-xl p-10 text-center shadow-sm">
                        <span class="material-icons text-6xl text-slate-400 mb-4">shopping_cart</span>
                ...
                <?php else: ?>
                    <!-- Bulk Actions Bar -->
                    <div id="bulkActions" class="mb-4 bg-white rounded-2xl p-4 shadow-sm border border-[#f0d8c8]" style="display: none;">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-white dark:bg-slate-800/50 rounded-xl p-6 shadow-sm sticky top-24">
                                ...
                                <div id="nextCouponInfo" class="mb-4 p-4 bg-[#fff0e8] border border-[#f0d8c8] rounded-lg"
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p id="nextCouponText" class="font-semibold text-slate-900 mb-1">
                                                <?php if (isset($nextCouponInfo) && $nextCouponInfo): ?>
                                                🎁 Mua thêm <?= number_format($nextCouponInfo['needed'], 0, ',', '.') ?>đ để nhận ưu đãi!
                                                <?php endif; ?>
                                            </p>
                                            <p id="nextCouponDetail" class="text-sm text-slate-600">
                                                <?php if (isset($nextCouponInfo) && $nextCouponInfo): ?>
                                            ...
                                            <a href="<?= BASE_URL ?>?action=products" class="inline-flex items-center gap-1 mt-2 text-xs font-semibold text-primary hover:underline">
