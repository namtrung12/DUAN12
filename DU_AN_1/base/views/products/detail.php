                            ...
                            <div class="pt-2">
                                ...
                                <div class="rounded-xl border border-gray-300 bg-gray-50 p-3">
                                    <div class="flex items-end justify-between gap-3">
                                        <div>
                                            <label class="block text-slate-900 text-xs font-semibold mb-1">Số lượng</label>
                                            <div class="inline-flex items-center rounded-lg border border-gray-300 bg-white overflow-hidden">
                                                <button type="button" onclick="decreaseQuantity()" class="w-9 h-9 flex items-center justify-center hover:bg-gray-50 transition-colors text-slate-700 text-lg font-bold" aria-label="Giảm số lượng">-</button>
                                                <input type="number" name="quantity" id="quantity" value="1" min="1" max="99"
                                                    class="w-12 h-9 text-center text-sm font-bold border-x border-gray-300 focus:outline-none focus:border-amber-600" />
                                                <button type="button" onclick="increaseQuantity()" class="w-9 h-9 flex items-center justify-center hover:bg-gray-50 transition-colors text-slate-700 text-lg font-bold" aria-label="Tăng số lượng">+</button>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <label class="block text-slate-500 text-xs mb-1">Tổng tiền</label>
                                            <p class="text-amber-600 font-bold text-2xl leading-none" id="product-price">
                                ...
                                <!-- Add to Cart Button -->
                                <button type="submit" class="w-full mt-3 h-10 bg-amber-600 text-white rounded-lg font-bold text-sm shadow-md hover:bg-amber-700 transition-colors flex items-center justify-center">
                                    Thêm vào giỏ hàng
                                </button>
                            </div>
                        </form>
                                ...
                                <div class="border-b border-gray-200 pb-6 last:border-b-0">
                                    <div class="flex items-start gap-4">
                                        ...
                                        $avatarUrl = (!empty($review['user_avatar']) && isset($review['user_avatar'])) 
                                            ...
                                            : 'https://ui-avatars.com/api/?name=' . urlencode($review['user_name']) . '&size=48&background=F2B07A&color=fff';
                                        ?>
                                        <img src="<?= $avatarUrl ?>" alt="Avatar" class="w-12 h-12 min-w-[48px] rounded-full object-cover border-2 border-gray-200" onerror="this.src='https://ui-avatars.com/api/?name=<?= urlencode($review['user_name']) ?>&size=48&background=F2B07A&color=fff'">
                                        <div class="flex-1">
