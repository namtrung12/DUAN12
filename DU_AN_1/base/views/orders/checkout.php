                    ...
                    <form action="<?= BASE_URL ?>?action=checkout-process" method="POST" class="flex flex-col lg:flex-row gap-12 mt-8">
                        <div class="w-full lg:w-2/3">
                            ...
                            <div class="bg-white rounded-xl shadow-sm p-6 md:p-8 mt-8">
                                <h2 class="text-custom-text text-[22px] font-bold leading-tight tracking-[-0.015em] mb-4">Phương thức vận chuyển</h2>
                                <p class="text-sm text-custom-text/70 mb-5">Quy trình giao hàng phổ biến: xác nhận đơn, chuẩn bị món, bàn giao tài xế và giao tận nơi.</p>

                                <label class="flex items-start p-4 border-2 border-gray-200 rounded-lg cursor-pointer has-[:checked]:border-custom-primary has-[:checked]:bg-custom-primary/10 transition-all">
                                    <input checked class="form-radio h-5 w-5 text-custom-primary focus:ring-custom-primary/50 mt-1" name="shipping_method" type="radio" value="standard" />
                                    <div class="ml-4 flex-grow">
                                        <div class="flex items-center justify-between gap-3 flex-wrap">
                                            <div class="flex items-center gap-2">
                                                <span class="material-icons text-custom-text/80">local_shipping</span>
                                                <p class="font-semibold text-custom-text">Giao tiêu chuẩn nội thành</p>
                                            </div>
                                            <div class="text-right">
                                                <p class="text-xs text-custom-text/60">Dự kiến</p>
                                                <p class="text-sm font-semibold text-custom-text">30 - 45 phút</p>
                                            </div>
                                        </div>
                                        <p class="text-sm text-custom-text/60 mt-1">Theo dõi trạng thái theo từng bước ngay trong mục đơn hàng.</p>
                                        <p class="text-sm text-custom-text/70 mt-2">Phí vận chuyển: <strong><?= number_format($shippingFee, 0, ',', '.') ?>đ</strong></p>
                                    </div>
                                </label>

                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mt-5">
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-3">
                                        <p class="text-xs text-custom-text/60 uppercase tracking-wide">Bước 1</p>
                                        <p class="text-sm font-semibold text-custom-text mt-1">Xác nhận đơn</p>
                                    </div>
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-3">
                                        <p class="text-xs text-custom-text/60 uppercase tracking-wide">Bước 2</p>
                                        <p class="text-sm font-semibold text-custom-text mt-1">Chuẩn bị món</p>
                                    </div>
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-3">
                                        <p class="text-xs text-custom-text/60 uppercase tracking-wide">Bước 3</p>
                                        <p class="text-sm font-semibold text-custom-text mt-1">Bàn giao tài xế</p>
                                    </div>
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-3">
                                        <p class="text-xs text-custom-text/60 uppercase tracking-wide">Bước 4</p>
                                        <p class="text-sm font-semibold text-custom-text mt-1">Giao thành công</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="space-y-4">
                                    <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer has-[:checked]:border-custom-primary has-[:checked]:bg-custom-primary/10 transition-all">
                                        ...
                                        <div class="ml-4 flex-grow flex items-center">
                                            <span class="material-icons text-custom-text/80 mr-3">local_shipping</span>
                                            <div>
                                    ...
                                    <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer has-[:checked]:border-custom-primary has-[:checked]:bg-custom-primary/10 transition-all">
                                        ...
                                        <div class="ml-4 flex-grow flex items-center">
                                            <span class="material-icons text-custom-text/80 mr-3">account_balance</span>
                                            <div>
                                    ...
                                    <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer has-[:checked]:border-custom-primary has-[:checked]:bg-custom-primary/10 transition-all">
                                        ...
                                        <div class="ml-4 flex-grow flex items-center">
                                            <span class="material-icons text-custom-text/80 mr-3">account_balance_wallet</span>
                                            <div>
                        ...
                        <div class="w-full lg:w-1/3">
                            <div class="bg-white rounded-xl shadow-sm p-6 sticky top-8">
                                ...
                                <div class="mt-6 pt-6 border-t border-dashed">
                                    ...
                                    <div class="flex justify-between items-center mb-2">
                                        <p class="text-custom-text/70">Phí vận chuyển (Tiêu chuẩn)</p>
