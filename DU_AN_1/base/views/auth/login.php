                ...
                <div class="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div class="w-full max-w-md">
                            ...
                            <div class="mb-6">
                                <div class="flex border-b border-gray-200">
                                    ...
                                    <a href="<?= BASE_URL ?>?action=register" class="flex-1 py-3 px-4 text-center font-medium text-text-secondary">Đăng ký</a>
                                </div>
                            </div>
                            <h1 class="text-text-primary tracking-light text-3xl font-bold leading-tight text-left pb-1">Chào mừng trở lại</h1>
                            <p class="text-text-secondary text-base font-normal leading-normal pb-6">Đăng nhập để tiếp tục đặt đồ và theo dõi đơn hàng.</p>
                            ...
                            <form action="<?= BASE_URL ?>?action=post-login" method="POST" class="space-y-4">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-text-primary focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-gray-300 bg-background-light h-14 placeholder:text-text-secondary p-4 text-base font-normal leading-normal" id="email" name="email" placeholder="Nhập email của bạn" type="email" value="<?= htmlspecialchars($prefillEmail, ENT_QUOTES, 'UTF-8') ?>" required />
                                ...
                                <div class="flex flex-col">
                                    <div class="flex justify-between items-center pb-2">
                                        <label class="text-text-primary text-base font-medium leading-normal" for="password">Mật khẩu</label>
                                    </div>
                                    <input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-text-primary focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-gray-300 bg-background-light h-14 placeholder:text-text-secondary p-4 text-base font-normal leading-normal" id="password" name="password" placeholder="Nhập mật khẩu của bạn" type="password" value="<?= htmlspecialchars($prefillPassword, ENT_QUOTES, 'UTF-8') ?>" required />
                    ...
                    <div class="relative hidden lg:flex items-center justify-center bg-accent/40 order-1 lg:order-2">
                        ...
                        <div class="relative w-full max-w-lg p-8">
                            <div class="rounded-3xl border border-white/40 bg-white/50 backdrop-blur-md p-8 shadow-xl">
                                <h3 class="text-2xl font-bold text-slate-900 mb-4">Đặt đồ nhanh hơn</h3>
                                <ul class="space-y-3 text-slate-700">
                                    <li class="flex items-center gap-2">
                                        <span class="material-icons text-primary">check_circle</span>
                                        Tùy chỉnh đá, đường và topping trong 1 bước
                                    </li>
                                    <li class="flex items-center gap-2">
                                        <span class="material-icons text-primary">check_circle</span>
                                    ...
                                    <li class="flex items-center gap-2">
                                        <span class="material-icons text-primary">check_circle</span>
                                        Tích điểm đổi ưu đãi cho mỗi đơn đặt
                                    </li>
                                </ul>
                            </div>
                        </div>
