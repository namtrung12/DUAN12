...
class Order extends BaseModel
{
    ...
    {
        $sql = "SELECT oi.*, 
                COALESCE(p.name, 'Sản phẩm đã xóa') as product_name, 
                COALESCE(p.image, '') as image, 
                ps.size_id, 
                COALESCE(s.name, 'N/A') as size_name 
                FROM order_items oi 
    ...
    {
        // Tự động hoàn thành sau 30 phút kể từ lúc chuyển sang đang giao.
        // Nếu là COD thì đồng thời cập nhật trạng thái thanh toán sang paid.
