...
--
-- Sự kiện tự động hoàn thành đơn hàng đang giao sau 30 phút
--
DROP EVENT IF EXISTS `ev_auto_complete_delivering_orders`;
CREATE EVENT `ev_auto_complete_delivering_orders`
